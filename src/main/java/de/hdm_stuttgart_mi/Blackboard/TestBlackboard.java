...
public class TestBlackboard {
    public static void main(String[] args) {
        ...
        Roommate testRoommate = new Roommate("Marcel", "Alex", 333, "01712151427", "", LocalDate.parse("10.11.2010",formatter), LocalDate.parse("20.12.2020",formatter),"/src/resources/images/Lucifer.jpg");
